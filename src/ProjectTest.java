...
public class ProjectTest {
	 ...
	 * @param args
	 *            original arguments sent to {@link Driver}
	 * @param message
	 *            error message with more details
	 * @return formatted error message
	 */
	public static String errorMessage(Path actual, Path expected, String[] args, String message) {
		return String.format(ERROR_FORMAT, actual.toString(), expected.toString(), String.join(" ", args), message);
	}
	...
	public static boolean isEnvironmentSetup() {
		...
		return Files.isReadable(Paths.get("expected")) && Files.isWritable(Paths.get("out"));
	}
	...
	public static void checkOutput(Path expected, Path actual, String[] args) {
		...
		try {
			...
			if (!Files.isReadable(expected)) {
				...
				Assert.fail(errorMessage(actual, expected, args, message));
			}
